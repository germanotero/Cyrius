...
/*     */ 
/*     */   public VerTurnosJPanel(TurnosFrame parent)
/*     */     throws ConfigFileException
/*     */   {
/* 102 */     this.parent = parent;
/* 103 */     initComponents();
/* 104 */     checkRecordatorio();
/* 105 */     this.calendario.getDateSelectionModel().setSelectionMode(
/* 106 */       DateSelectionModel.SelectionMode.SINGLE);
/*     */   }
/*     */ 
...
/* 147 */     this.scrolPanelTurnos.setBorder(
/* 148 */       new BevelBorder(0));
/* 149 */     this.scrolPanelTurnos
/* 150 */       .setViewportBorder(new EtchedBorder());
...
/* 162 */     this.txtHelp
/* 163 */       .setText("Para comenzar el uso, usted tiene que seleccionar un medico, y luego le aparecera un calendario, en el cual usted debe seleccionar la fecha a ver los turnos de dicho medico.");
/*     */ 
...
/* 171 */     this.rbtnTTarde.setBorder(
/* 172 */       new EmptyBorder(new Insets(1, 1, 1, 1)));
...
/* 183 */     this.rbtnTManana.setBorder(
/* 184 */       new EmptyBorder(new Insets(1, 1, 1, 1)));
...
/* 193 */     pnTurnosCalendario.setBorder(
/* 194 */       new BevelBorder(0));
...
/* 199 */     this.calendario
/* 200 */       .addDateSelectionListener(new DateSelectionListener()
/*     */     {
...
/* 263 */     this.calendario.getDateSelectionModel().setDateSelectionIterval(
/* 264 */       date.getTime(), date.getTime());
/*     */   }
/*     */ 
...
/* 286 */       fecha.setTime(
/* 287 */         this.calendario.getDateSelectionModel().getLeadSelectionDate());
...
/* 302 */       fecha.setTime(
/* 303 */         this.calendario.getDateSelectionModel().getLeadSelectionDate());
...
/* 321 */       panel
/* 322 */         .addComponentListener(new RefreshTablaTurnosPrincipalListener());
/*     */     } catch (Throwable e) {
...
/*     */   {
/* 331 */     if (this.cbMedicos.getSelectedItem() == null)
/* 332 */       return;
...
/*     */     }
/* 341 */     if (((Medico)this.cbMedicos.getSelectedItem()).getAtiendeDeTarde(
/* 342 */       (Calendar)this.calendario.getValor())) {
/* 343 */       this.rbtnTTarde.setEnabled(true);
/* 344 */       if (!this.rbtnTManana.isEnabled())
/* 345 */         this.rbtnTTarde.doClick();
/*     */     }
/*     */     else {
...
/* 363 */         fecha.setTime(
/* 364 */           this.calendario.getDateSelectionModel().getLeadSelectionDate());
/* 365 */         if (((Medico)this.cbMedicos.getSelectedItem()).getAtiendeDeManana(
/* 366 */           (Calendar)this.calendario.getValor())) {
/* 367 */           this.rbtnTManana.setEnabled(true);
/*     */         }
/* 369 */         if (((Medico)this.cbMedicos.getSelectedItem()).getAtiendeDeTarde(
/* 370 */           (Calendar)this.calendario.getValor())) {
/* 371 */           this.rbtnTTarde.setEnabled(true);
/*     */         }
/*     */       }
/* 374 */       Medico medico = (Medico)this.cbMedicos.getSelectedItem();
/* 375 */       NoAtiendeSelectionMode noAtiendeSelectionMode = new NoAtiendeSelectionMode(
/* 376 */         medico);
/* 377 */       noAtiendeSelectionMode
/* 378 */         .setCancelSelectionOnNotAviableDays4Medic(true);
...
/* 434 */         VerTurnosJPanel.this.tablaTurnos.setRowSelectionInterval(VerTurnosJPanel.this.tablaTurnos
/* 435 */           .rowAtPoint(e.getPoint()), VerTurnosJPanel.this.tablaTurnos.rowAtPoint(e.getPoint()));
/* 436 */         if ((e.isPopupTrigger()) && 
/* 437 */           (VerTurnosJPanel.this.tablaTurnos.getSelectedRowCount() > 0) && 
/* 438 */           (VerTurnosJPanel.this.tablaTurnos.hasTurno(VerTurnosJPanel.this.tablaTurnos.getSelectedRow())))
...
/* 456 */       uc.getInternalWindow().setDefaultCloseOperation(
/* 457 */         3);
/*     */     } catch (Exception e) {
...
/* 480 */       uc.getInternalWindow().setDefaultCloseOperation(
/* 481 */         3);
/* 482 */       uc.getInternalWindow().getWraped().addComponentListener(
/* 483 */         new RefreshTablaTurnosPrincipalListener());
...
/* 493 */       StringProvider.getInstance().getValueOf("TituloBorradoTurno"), 
/* 494 */       2);
/* 495 */     if (resp == 0) {
...
/* 500 */           StringProvider.getInstance().getValueOf(
/* 501 */           "ImposibleBorrarTurnoTitulo"), 
/* 502 */           0);
/*     */       } else {
...
/*     */ 
/*     */   public void refresh() {
/* 511 */     if (this.rbtnTManana.isSelected())
/* 512 */       this.rbtnTManana.doClick();
/*     */     else
/* 514 */       this.rbtnTTarde.doClick();
/*     */   }
/*     */ 
 ...
 * Qualified Name:     com.cyrius.turnos.gui.verTurno.VerTurnosJPanel
