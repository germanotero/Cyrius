...
public class TurnosFrame extends JFrame
{
  ...
  private void initComponents() {
    ...
    this.miListaPacientes.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent arg0) {
        miListaPacientesActionPerformed(arg0, TurnosFrame.this);
      }
      private void miListaPacientesActionPerformed(ActionEvent arg0, JFrame parent) {
            jDialogBuscarPersona inst = new jDialogBuscarPersona(parent);
    ...
    this.administradores.add(miListaPacientes);
    this.administrarMedicos.setText("Medicos");
    this.administrarMedicos
  ...
  private void launchUseCase(Class<? extends AbstractUseCaseFactory> useCase)
  {
    try {
      ...
      FrameworkUseCaseFactory.launchUseCase(
        (AbstractUseCaseFactory)FrameworkUseCaseFactory.createChildUseCase(useCase, this));
    } catch (Throwable e) {
      ExceptionHandler.getInstance().handle(e);
    } finally {
